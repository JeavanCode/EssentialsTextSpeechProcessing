...
plt.title("Emotion Scores by Year (1990-2017)")
plt.legend()
plt.grid(True)
plt.savefig('./Figures/emotion_scores_1990_2017.png')
plt.show()

# Mental Health Trends vs Emotion Scores
for column in merged_data.columns[4:]:
    plt.figure(figsize=(12, 6))
    ...
    plt.xlabel("Year")
    plt.ylabel("Rate")
    plt.title(f"{column} vs Negative Emotion Score (1990-2017)")
    plt.legend()
    plt.grid(True)
    plt.savefig(f'./Figures/{column}_vs_negative_emotion_1990_2017.png')
    plt.show()
